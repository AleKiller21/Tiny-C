...
$(AST_EXPRESSION)/cast/cast_expression.o: $(AST_EXPRESSION)/cast/cast_expression.cpp $(AST_EXPRESSION)/cast/cast_expression.h $(AST_EXPRESSION)/expression.h $(AST_DECLARATOR)/abstract_declarator.h
	g++ -std=c++11 -c -o $@ $<
...
$(UNARY_EXPRESSION)/sizeof/sizeof_expression.o: $(UNARY_EXPRESSION)/sizeof/sizeof_expression.cpp $(UNARY_EXPRESSION)/sizeof/sizeof_expression.h $(UNARY_EXPRESSION)/unary_expression.h $(AST_EXPRESSION)/expression.h $(AST_DECLARATOR)/abstract_declarator.h
	g++ -std=c++11 -c -o $@ $<
...
$(BINARY_EXPRESSION)/assign/assignment_expression.o: $(BINARY_EXPRESSION)/assign/assignment_expression.cpp $(BINARY_EXPRESSION)/assign/assignment_expression.h $(BINARY_EXPRESSION)/binary_expression.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<
...
$(AST_STATEMENT)/block/block_statement.o: $(AST_STATEMENT)/block/block_statement.cpp $(AST_STATEMENT)/block/block_statement.h $(AST_STATEMENT)/statement.h $(AST_DECLARATOR)/declaration_list/declaration_list.h
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/simple/simple_declarator.o: $(AST_DECLARATOR)/simple/simple_declarator.cpp $(AST_DECLARATOR)/simple/simple_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/array/array_declarator.o: $(AST_DECLARATOR)/array/array_declarator.cpp $(AST_DECLARATOR)/array/array_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/parameter_list/parameter_list.o: $(AST_DECLARATOR)/parameter_list/parameter_list.cpp $(AST_DECLARATOR)/parameter_list/parameter_list.h $(AST_DECLARATOR)/declarator.h $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/function/function_declarator.o: $(AST_DECLARATOR)/function/function_declarator.cpp $(AST_DECLARATOR)/function/function_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_DECLARATOR)/parameter_list/parameter_list.h $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/initializer/initializer.o: $(AST_DECLARATOR)/initializer/initializer.cpp $(AST_DECLARATOR)/initializer/initializer.h $(AST_EXPRESSION)/expression_list/expression_list.h $(AST_EXPRESSION)/expression.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/declarator_list/declarator_list.o: $(AST_DECLARATOR)/declarator_list/declarator_list.cpp $(AST_DECLARATOR)/declarator_list/declarator_list.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/declaration/declaration.o: $(AST_DECLARATOR)/declaration/declaration.cpp $(AST_DECLARATOR)/declaration/declaration.h $(AST_DECLARATOR)/declarator_list/declarator_list.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/external_declaration.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/declaration_list/declaration_list.o: $(AST_DECLARATOR)/declaration_list/declaration_list.cpp $(AST_DECLARATOR)/declaration_list/declaration_list.h $(AST_DECLARATOR)/declaration/declaration.h $(AST_DECLARATOR)/declarator_list/declarator_list.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_EXPRESSION)/expression_list/expression_list.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<

$(AST_FUNCTION)/function_definition.o: $(AST_FUNCTION)/function_definition.cpp $(AST_FUNCTION)/function_definition.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/external_declaration.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_EXPRESSION)/expression_list/expression_list.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_EXPRESSION)/expression.h $(AST_STATEMENT)/statement.h
	g++ -std=c++11 -c -o $@ $<

$(UNARY_EXPRESSION)/printf/printf_expression.o: $(UNARY_EXPRESSION)/printf/printf_expression.cpp $(UNARY_EXPRESSION)/printf/printf_expression.h $(UNARY_EXPRESSION)/unary_expression.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<

$(UNARY_EXPRESSION)/scanf/scanf_expression.o: $(UNARY_EXPRESSION)/scanf/scanf_expression.cpp $(UNARY_EXPRESSION)/scanf/scanf_expression.h $(UNARY_EXPRESSION)/unary_expression.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<
...
clean:
	...
	rm -f $(AST_STATEMENT)/**/*.o
	rm -f $(AST_DECLARATOR)/**/*.o
	rm -f $(AST_FUNCTION)/*.o
	rm -f $(TARGET)