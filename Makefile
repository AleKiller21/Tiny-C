...
PURE_HEADER=ast.h $(AST_TYPES) $(AST_EXPRESSION)/expression.h $(UNARY_EXPRESSION)/unary_expression.h $(BINARY_EXPRESSION)/binary_expression.h $(BINARY_EXPRESSION)/assign/assignment_expression.h $(AST_STATEMENT)/statement.h $(AST_DECLARATOR)/declarator.h
...
$(AST_DECLARATOR)/declaration/declaration.o: $(AST_DECLARATOR)/declaration/declaration.cpp $(AST_DECLARATOR)/declaration/declaration.h $(AST_DECLARATOR)/declarator_list/declarator_list.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<
...
$(AST_FUNCTION)/function_definition.o: $(AST_FUNCTION)/function_definition.cpp $(AST_FUNCTION)/function_definition.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/initializer/initializer.h $(AST_EXPRESSION)/expression_list/expression_list.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h $(AST_EXPRESSION)/expression.h $(AST_STATEMENT)/statement.h
	g++ -std=c++11 -c -o $@ $<
