...
$(AST_DECLARATOR)/simple/simple_declarator.o: $(AST_DECLARATOR)/simple/simple_declarator.cpp $(AST_DECLARATOR)/simple/simple_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_TYPES) $(AST_EXPRESSION)/primary/id/id_expression.h
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/array/array_declarator.o: $(AST_DECLARATOR)/array/array_declarator.cpp $(AST_DECLARATOR)/array/array_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_TYPES) $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/parameter/parameter_declarator.o: $(AST_DECLARATOR)/parameter/parameter_declarator.cpp $(AST_DECLARATOR)/parameter/parameter_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/parameter_list/parameter_list.o: $(AST_DECLARATOR)/parameter_list/parameter_list.cpp $(AST_DECLARATOR)/parameter_list/parameter_list.h $(AST_DECLARATOR)/parameter/parameter_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<

$(AST_DECLARATOR)/function/function_declarator.o: $(AST_DECLARATOR)/function/function_declarator.cpp $(AST_DECLARATOR)/function/function_declarator.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/parameter_list/parameter_list.h $(AST_TYPES)
	g++ -std=c++11 -c -o $@ $<
