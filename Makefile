...
$(AST_STATEMENT)/for/for_statement.o: $(AST_STATEMENT)/for/for_statement.cpp $(AST_STATEMENT)/for/for_statement.h $(AST_STATEMENT)/expression/expression_statement.h $(AST_STATEMENT)/statement.h $(AST_EXPRESSION)/expression.h
	g++ -std=c++11 -c -o $@ $<
