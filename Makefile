...
PURE_HEADER=ast.h $(AST_TYPES) $(AST_EXPRESSION)/expression.h $(UNARY_EXPRESSION)/unary_expression.h $(BINARY_EXPRESSION)/binary_expression.h $(BINARY_EXPRESSION)/assign/assignment_expression.h $(AST_STATEMENT)/statement.h $(AST_DECLARATOR)/declarator.h $(AST_DECLARATOR)/external_declaration.h $(AST_DECLARATOR)/abstract_declarator.h
