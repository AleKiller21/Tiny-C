...
asm_code *greater_equal_expression::generate_code(stack_manager *manager)
{
    asm_code *expr1_code;
    asm_code *expr2_code;
    asm_code *expr_code;
    ...
    else if(expr1->is_code)
    {
        ...
        reg_manager.free_register(expr1_code->place);
        treg = reg_manager.get_register(false);
        code += "\tslti " + treg + ", " + expr1_code->place + ", " + std::to_string(expr2_code->constant) + "\n";
        code += "\tslti " + treg + ", " + treg + ", 1\n";
    }
