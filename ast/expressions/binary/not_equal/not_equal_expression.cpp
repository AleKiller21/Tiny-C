...
asm_code *not_equal_expression::generate_code(stack_manager *manager)
{
    asm_code *expr1_code;
    asm_code *expr2_code;
    asm_code *expr_code;
    ...
    if(!code.empty())
    {
        ...
        code += "\tsne " + treg + ", " + expr1_code->place + ", " + expr2_code->place + "\n";
    }
    ...
    else if(expr1->is_code)
    {
        ...
        code += "\tsne " + treg + ", " + expr1_code->place + ", " + treg + "\n";
        reg_manager.free_register(expr1_code->place);
    }
    ...
    else
    {
        ...
        code += "\tsne " + treg + ", " + treg + ", " + expr2_code->place + "\n";
        reg_manager.free_register(expr2_code->place);
    }
