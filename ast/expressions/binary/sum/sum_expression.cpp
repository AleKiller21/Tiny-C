...
asm_code *sum_expression::generate_code(stack_manager *manager)
{
    asm_code *expr1_code;
    asm_code *expr2_code;
    asm_code *expr_code;
    ...
    if(!code.empty())
    {
        ...
        code += "\tadd " + treg + ", " + expr1_code->place + ", " + expr2_code->place + "\n";
    }
    ...
    else
    {
        ...
        reg_manager.free_register(expr2_code->place);
        treg = reg_manager.get_register(false);
        code += "\taddi " + treg + ", " + expr2_code->place + ", " + std::to_string(expr1_code->constant) + "\n";
    }
