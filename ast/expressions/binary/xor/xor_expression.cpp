...
asm_code *xor_expression::generate_code(stack_manager *manager)
{
    asm_code *expr1_code;
    asm_code *expr2_code;
    asm_code *expr_code;
    ...
    if(!code.empty())
    {
        ...
        code += "\txor " + treg + ", " + expr1_code->place + ", " + expr2_code->place + "\n";
    }
    ...
    else if(expr1->is_code)
    {
        ...
        reg_manager.free_register(expr1_code->place);
        treg = reg_manager.get_register(false);
        code += "\txori " + treg + ", " + expr1_code->place + ", " + std::to_string(expr2_code->constant) + "\n";
    }
    ...
    else
    {
        ...
        code += "\txor " + treg + ", " + treg + ", " + expr2_code->place + "\n";
        reg_manager.free_register(expr2_code->place);
    }
